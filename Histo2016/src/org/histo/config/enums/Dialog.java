...
public enum Dialog {
	...
	PHYSICIAN_SEARCH("/pages/dialog/settings/subDialog/physicianSearch", null, 1024, 600, false, false, true), // 4:3
	PHYSICIAN_EDIT("/pages/dialog/settings/subDialog/physicianEdit", null, 1024, 600, false, false, true), // 4:3
