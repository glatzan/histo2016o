...
public enum DocumentType {
	 ...
	 * DIAGNOSIS_REPORT 
	 */
	U_REPORT, U_REPORT_EMTY, U_REPORT_EMTY_ROTATED_180, U_REPORT_COMPLETED, DIAGNOSIS_REPORT, DIAGNOSIS_REPORT_COMPLETED, DIAGNOSIS_REPORT_EXTERN, LABLE, BIOBANK_INFORMED_CONSENT, TEST_LABLE, COUNCIL_REQUEST, COUNCIL_REPLY, OTHER, EMPTY, NOTIFICATION_SEND_REPORT, MEDICAL_FINDINGS_SEND_REPORT_COMPLETED;
