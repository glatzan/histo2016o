...
public class SlideHandlerAction implements Serializable {
    ...
    /**
     * List for selecting staining, this list contains all stainigns not added in tmpSample
     */
    ...
    /**
     * In dieser Variable wird die Aktion gespeichert, die in der Objektträgerliste auf alle ausgewählten elemente ausgeführt werden soll.
     */
    private byte actionOnMany;

    /******************************************************** Add Slide to Block ********************************************************/
    /**
     * Zeigt einen Dialog um einen neunen Objektträger für eine Block zu erstellen
     * 
     * @param sample
     */
    ...
    public void addSelectedSlides(List<StainingListChooser> slideList, Block block, String commentary, boolean reStaining) {

	// überprüft ob eine neuer Objektträger erstellt werden soll, falls nicht wird abgebrochen
	...
	for (Sample sample : task.getSamples()) {
	    ...
	    // nur als completed markieren wenn mindestens eine Färbung vorhanden ist
    ...
    /**
     * Adds a new staining to a block. Needs the sample an the patient for logging. Commentary will be null.
     * 
     * @param prototype
     * @param sample
     * @param block
    ...
    /**
     * Adds a new staining to a block. Needs the sample an the patient for logging. Commentary the given string.
     * 
     * @param prototype
     * @param sample
     * @param block
	...
	Staining staining = TaskUtil.createNewStaining(block, prototype);
    ...
    /**
     * Saves all stainigs, if all stainigs are marked as performed prepareStainingsPerformed method is called
     * 
     * @param sample
     */
