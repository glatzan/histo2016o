...
import org.histo.action.dialog.settings.AbstractSettingsTab;
import org.histo.action.dialog.settings.PhysicianSettingsTab.Page;
...
public class SettingsDialogHandler extends AbstractDialog {
	...
	@Getter
	@Setter
	public AbstractSettingsTab[] tabs = new AbstractSettingsTab[] { new HistoUserTab() };
	...
	public class HistoUserTab extends AbstractSettingsTab {
		...
		private HistoUserPage page = HistoUserPage.LIST;

		{
			name = "dialog.settings.user";
		}
		 ...
		 * @param physician
		 */
		public void prepareEditPhysicianFromUserList(HistoUser histoUser) {
		...
		public void saveEditPhysicianFromUserList(Physician physician) {
			try {
				...
				genericDAO.saveDataRollbackSave(physician, resourceBundle.get("log.settings.physician.physician.edit",
...
//				}
//
//				genericDAO.saveDataRollbackSave(ldapPhysician, resourceBundle.get("log.settings.physician.ldap.save",
