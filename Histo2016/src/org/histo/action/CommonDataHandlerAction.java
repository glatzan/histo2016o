...
public class CommonDataHandlerAction {
	...
	public void setSelectedStainingTableChooser(StainingTableChooser selectedStainingTableChooser) {
		System.out.println(selectedStainingTableChooser + "---------------");
		this.selectedStainingTableChooser = selectedStainingTableChooser;
	}
