...
public class SettingsHandlerAction {
    ...
    /**
     * List for selecting staining, this list contains all stainings. They can be choosen and added to the staininglist
     */
	...
	helper.log.info("Benutzer Rechte geändert. Benutzer: " + user.getUsername() + ", alte Rolle: " + oldRole.getName() + ", neue Rolle: " + role.getName(), log);
    }
	...
	if (origStainingPrototype == null) {
	    ...
	    helper.log.info("Färbung veränder, Original: " + origStainingPrototype.asGson() + " Neu:" + newStainingPrototype.asGson(), log);
     ...
     */
    public void saveStainigList(StainingPrototypeList newStainingPrototypeList, StainingPrototypeList origStainingPrototypeList) {
	if (origStainingPrototypeList == null) {
	    ...
	    // case edit: update an save
	    helper.log.info("Färbungsliste veränder, Original: " + origStainingPrototypeList.asGson() + " Neu:" + newStainingPrototypeList.asGson(), log);
     ...
     */
    public void addStainingToStainingList(List<StainingListChooser> stainingListChoosers, StainingPrototypeList stainingPrototypeList) {
     ...
     * @param stainingPrototypeList
     */
    public void removeStainingFromStainingList(StainingPrototype toRemove, StainingPrototypeList stainingPrototypeList) {
    ...
    public void saveDiagnosisPrototype(DiagnosisPrototype newDiagnosisPrototype, DiagnosisPrototype origDiagnosisPrototype) {
	if (origDiagnosisPrototype == null) {
	    ...
	    // case edit: update an save
	    helper.log.info("Diagnose veränder, Original: " + origDiagnosisPrototype.asGson() + " Neu:" + newDiagnosisPrototype.asGson(), log);
	...
	getEditPhysician().setPerson(new Person());
    ...
    /******************************************************** History ********************************************************/
    /**
     * Loads the current history, for all events 100 entries. Shows the current history dialog.
     */
    ...
    /**
     * Loads the current history for the given patient. Shows the current history dialog.
     * 
     * @param patient
     */
    ...
    /**
     * Sets a new list with all DiagnosisProtoypes and creates a corresponding transformer
     */
	...
	setDiagnosisPrototypeListTransformer(new DiagnosisPrototypeListTransformer(getAllAvailableDiagnosisPrototypes()));
    }
    ...
    public void setDiagnosisPrototypeListTransformer(DiagnosisPrototypeListTransformer diagnosisPrototypeListTransformer) {
