...
\begin{tabular}{p{0.15\linewidth}p{0.25\linewidth}p{0.3\linewidth}p{0.3\linewidth}}
	...
	Freiburg den & & #if($task.diagnosisContainer.signatureOne.physician) $task.diagnosisContainer.signatureOne.physician.person.fullName #end & #if($task.diagnosisContainer.signatureTwo.physician) $task.diagnosisContainer.signatureTwo.physician.person.fullName #end \\
	~~ $task.diagnosisContainer.signatureDateAsDate & ~ & #if($task.diagnosisContainer.signatureOne.physician) $task.diagnosisContainer.signatureOne.role #end  & #if($task.diagnosisContainer.signatureTwo.physician) $task.diagnosisContainer.signatureTwo.role #end \\\\
