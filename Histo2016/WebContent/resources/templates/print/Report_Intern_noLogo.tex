...
\footnotesize 
\begin{tabular}{l r}
Dies ist ein technisch validierter Befundbericht, der erst durch eine ärztliche Unterschrift fachlich validiert ist.   &  {Seite \thepage\ / \pageref{LastPage}}
\end{tabular}
}
	...
	\begin{tabular}{p{0.47\linewidth}p{0.53\linewidth}}
		...
		& 
		{
			...
			\begin{tabular}[t]{p{0.38\linewidth}p{0.62\linewidth-8\tabcolsep}}
				...
				Operateur & $!task.getPrimarySurgeon() \\
